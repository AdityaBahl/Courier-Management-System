...
import loginimg from '../images/Deck_Artboard 6_PNG.png'
                ...
                <div className='sm:w-1/2 px-16'>
                    ...
                    <form className='flex flex-col gap-4' action=''>
                        ...
                        <div className='relative'>
                            <input type={passwordType} onChange={(event) => setValues((prev) => ({ ...prev, pass: event.target.value }))} className='p-2 mt-2 rounded-xl border w-full' name='password' placeholder='Password' />
                            <svg onClick={togglePassword} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-eye absolute top-7 right-3 -translate-y-1/2 " viewBox="0 0 16 16">
                        ...
                        <button disabled={submitButtonDisabled} onClick={handleSubmission} className='bg-[#002D74] rounded-xl text-white py-2 hover:scale-105 duration-300'>Login</button>
                    </form>
                    ...
                    <div class="mt-3 text-sm flex justify-between items-center">
                        ...
                        <button onClick={goto} className="py-2 px-5 bg-white border-rounded-xl hover:scale-105 duration-300">Register</button>
                    </div>
                </div>
